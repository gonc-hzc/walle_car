...
#define BMI088_GYRO_CS1_Pin GPIO_PIN_11
#define BMI088_GYRO_CS1_GPIO_Port GPIOB
#define BMI088_ACC_CS2_Pin GPIO_PIN_12
#define BMI088_ACC_CS2_GPIO_Port GPIOB
#define right_motorB6_Pin GPIO_PIN_6
#define right_motorB6_GPIO_Port GPIOB
#define left_motor_Pin GPIO_PIN_7
#define left_motor_GPIO_Port GPIOB
#define left_motorB8_Pin GPIO_PIN_8
#define left_motorB8_GPIO_Port GPIOB
